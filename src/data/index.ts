...
export const footerData = {
  ...
  aboutAuthor: 'Hi! I am Joshua, a software developer that focuses on web and mobile platforms',
  authorInterest:
...
export const socialLinks = {
  ...
  instagramLink: 'https://instagram.com/code.withjoo',
  portfolioLink: 'https://itsjo.works',
};
