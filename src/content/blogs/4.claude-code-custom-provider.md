...
A custom provider is any service that serves Anthropic-compatible or OpenAI-compatible models through its own endpoint. Using one gives you more model and provider options, often at a lower cost, without changing how you work in the terminal.
