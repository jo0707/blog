...
<template>
    <div class="w-full h-full flex flex-col justify-center bg-[#020420]">
        ...
        <div class="w-[600px] pl-[100px]">
            <p v-if="category" class="uppercase text-[24px] text-[#00DC82] mb-4 font-semibold">
                {{ category }}
            </p>
            ...
            <div class="mt-8 flex items-center gap-3">
                <div
                    class="w-12 h-12 rounded-full bg-[#00DC82] flex items-center justify-center text-[#020420] font-bold text-xl">
                    J
                </div>
                <p class="text-[18px] text-[#A1A1AA]">
                    {{ siteName }}
                </p>
            </div>
        </div>
